$(document).ready(function(){
    ...
    // $("#btnAllpost").click(function () {
    //
    //     viewList();
    //     console.log("********************8DISPLAYING DATA GET ********************");
    //
    //     alert("clicked");
        $
            .ajax({
...
function viewList(){
// let path="http://localhost:8080/post/getall";
// $.getJSON("http://localhost:8080/post/getall",
//     $
//         .ajax({
//             url: "http://localhost:8080/post/getall",
//             type: "GET",
...
//
//     //  let count = 0;
//     // let path1= "http://localhost:8080/post/getall";
//     // $.ajax({
//     //     url: path1,
//     //     type: "GET",
//     //     dataType: 'json',
